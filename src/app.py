...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice team soccer skills and compete against other schools",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "nora@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Develop swim techniques and train for local swim meets",
    ...
    "Drama Club": {
        "description": "Practice acting, stage production, and perform original plays",
    ...
    "Robotics Club": {
        "description": "Build robots, learn coding, and compete in robotics challenges",
